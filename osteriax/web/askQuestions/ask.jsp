...
<html>
    <head>
        ...
        <title>Ask From Us OsterX</title>
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="user" placeholder="ex: John Laughfs" required="required">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadio3">Ask About Foods</label>
                   </div>
                   <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="category" id="inlineRadio4" value="4">
                    <label class="form-check-label" for="inlineRadio4">Ask Vaccinations</label>
                   </div>
